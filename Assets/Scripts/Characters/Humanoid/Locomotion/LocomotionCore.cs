...
namespace MNAC.Characters.Humanoid.Locomotion
{
    ...
    internal class LocomotionCore : HumanoidComponent
    {
        ...
        public override void Initialize(Blackboard blackboard)
        {
            ...
            walking = new(definitions.Walking, definitions.MutativeDrag, groundDetector);
            ...
            boosting = new(definitions.Walking, definitions.Boosting, definitions.MutativeDrag, groundDetector);
