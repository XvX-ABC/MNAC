...
namespace Tests.Behaviours.Arms.Weapons.Sword
{
    internal class Boosting : ArmedArmStateBase
    {
        ...
        public Boosting(BoostingLocomotion locomotion, LocomotionCore locomotionCore, IRotationLocker rotationLocker, ITargetLocker targetLocker, IBaseInput input, float duration) : base("boosting", 0)
        {
