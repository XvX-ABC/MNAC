...
namespace Minimalist.Bar.Editor
{
    ...
    public class BarEditor : UnityEditor.Editor
    {
        ...
        private SerializedProperty _labelDisplayOptions;
        private SerializedProperty _labelDisplayFormat;
        private SerializedProperty _labelMinFillAmount;
        private SerializedProperty _labelMaxFillAmount;
        ...
        private void OnEnable()
        {
            ...
            _labelDisplayOptions = serializedObject.FindProperty("_labelDisplayOptions");

            _labelDisplayFormat = serializedObject.FindProperty("_labelDisplayFormat");

            _labelMinFillAmount = serializedObject.FindProperty("_labelMinFillAmount");

            _labelMaxFillAmount = serializedObject.FindProperty("_labelMaxFillAmount");
        ...
        private void LabelsSection()
        {
            ...
            EditorExtensions.PropertyField("Display Options", _labelDisplayOptions, _displayLabel.boolValue);

            bool enforcingLabelDisplayMinCriterion =
                _labelDisplayOptions.intValue == (int)LabelDisplayOptions.IfFillAmountIsMoreThan ||
                _labelDisplayOptions.intValue == (int)LabelDisplayOptions.IfFillAmountIsBetween;

            bool enforcingLabelDisplayMaxCriterion =
                _labelDisplayOptions.intValue == (int)LabelDisplayOptions.IfFillAmountIsLessThan ||
                _labelDisplayOptions.intValue == (int)LabelDisplayOptions.IfFillAmountIsBetween;

            EditorExtensions.PropertyField("", _labelMinFillAmount, enforcingLabelDisplayMinCriterion, GUILayout.Width(50));

            EditorExtensions.PropertyField("", _labelMaxFillAmount, enforcingLabelDisplayMaxCriterion, GUILayout.Width(50));

            EditorGUILayout.EndHorizontal();

            EditorExtensions.PropertyField("Display Format", _labelDisplayFormat, _displayLabel.boolValue);
