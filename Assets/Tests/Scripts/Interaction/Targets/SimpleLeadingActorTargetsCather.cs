...
{
    internal class SimpleLeadingActorTargetsCather : TargetsCatcherBase
    {
        ...
        public SimpleLeadingActorTargetsCather(ILeadingActorTargetsCatcherDefinitions definitions, GameObject actorObj, Camera camera, IInput input, LocomotionCore locomotion)
        {
