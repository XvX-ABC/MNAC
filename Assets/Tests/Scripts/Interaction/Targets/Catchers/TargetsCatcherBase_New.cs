...
{
    public abstract class TargetsCatcherBase_New<T> : ITargetsCatcher_New<T> where T : ITarget
    {
        protected internal List<T> targets;
        protected internal Action<IList<T>> targetsChangedAction;
        ...
        public Action<IList<T>> TargetsChangedAction { get => targetsChangedAction; set => targetsChangedAction = value; }
        ...
        internal protected virtual void AddTarget(T target)
        {
            if (target == null)
        ...
        internal protected virtual void RemoveTarget(T target)
        {
            if (target == null)
                throw new ArgumentNullException(nameof(target));
