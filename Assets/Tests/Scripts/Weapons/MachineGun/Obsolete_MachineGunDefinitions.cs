...
{
    public class Obsolete_MachineGunDefinitions : MonoBehaviour, IMachineGunDefinitions
    {
        [SerializeField]
        JsonAssetAgent_Managed<ObsoleteMachineGunNumericalDefinitions> _numericalDefinitionsAsset;
        [SerializeField]
