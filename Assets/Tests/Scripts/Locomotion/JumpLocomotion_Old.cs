...
{
    [Obsolete]
    class JumpLocomotion_Old : IModule
    {
        public enum State
        {
            Idle,
        ...
        {
            JumpLocomotion_Old _locomotion;

            public PrepareCompleted(float triggerProportion, JumpLocomotion_Old locomotion) : base(triggerProportion)
            {
        ...
        class Ascending : RangeEvent
        {
            ...
            public Ascending(float triggeredProportion, float durationProportion, JumpLocomotion_Old locomotion) : base(durationProportion, triggeredProportion)
            {
                _locomotion = locomotion;
            }
        ...
        class AscendingEnd : PointEvent
        {
            ...
            public AscendingEnd(float triggeredProportion, JumpLocomotion_Old locomotion) : base(triggeredProportion)
            {
                _locomotion = locomotion;
            }
        ...
        public JumpLocomotion_Old(IJumpDefinitions definition)
        {
