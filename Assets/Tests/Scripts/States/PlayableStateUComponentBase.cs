...
{
    public abstract class PlayableStateUComponentBase : PlayableStateUComponentBase<object>
    {
    }
    public abstract class PlayableStateUComponentBase<T> : StateUComponentBase<T>, IPlayableState<T>
    {
