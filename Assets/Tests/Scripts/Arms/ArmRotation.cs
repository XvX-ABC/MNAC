...
namespace Assets.Scripts.Tests.Arms
{
    ...
    public class ArmRotation : MonoBehaviour
    {
        ...
        //{
        //    var l0 = (_shoulder.transform.position - _hand.transform.position).magnitude;
        //    var l1 = (_shoulder.transform.position - _elbow.transform.position).magnitude;
        //    var l2 = (_hand.transform.position - _elbow.transform.position).magnitude;

        //    var r0 = Mathf.Pow(l0, 2) + Mathf.Pow(l1, 2) - Mathf.Pow(l2, 2);
        //    var r1 = 2 * l0 * l1;
        //    _minAngle = r0 / r1;
        //}
        ...
        void Update()
        {
            ...
            //var pos = _shoulder.transform.position;
            //var rotation = CalculateRotation_Step_0(towards);
            //var v = rotation*_forward_s;
            //Debug.DrawLine(pos, pos + v.normalized * 10, Color.yellow);
            //_shoulder.transform.rotation = rotation;
