...
namespace Tests.BodyBehaviour.Arm.Animations
{
...

    {
        ...
        Animator _animator;
        public ArmWeaponAnimator(ArmBehavioursCore core, Animator animator, IArmAnimationDefinitions definitions, (string, IArmWeaponHoldingBehavioursAnimator)[] animatorMappings)
        {
