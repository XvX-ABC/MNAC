...
namespace Tests.Characters.Utilities
{
    ...
    internal class CharacterGeneratesController<T> : MonoBehaviour where T : CharacterBase, IDamageableWithCallback
    {
        ...
        [Serializable]
        internal class RespawnPointsCircularManager
        {
            [SerializeField]
            ...
            public RespawnPointsCircularManager()
            {
            ...
            public void GeneratePoints(Transform parent)
            {
                if (_respawnPoints == null)
                    _respawnPoints = new RespawnPoint[_amount];
        ...
        [SerializeField]
        RespawnPointsCircularManager _respawnPointsManager;
        ...
        private void Awake()
        {
            ...
            _respawnPointsManager.ownerObj = this.gameObject;
            _healthCallback = new(_characters);
        }
        private void Start()
        {
            _respawnPointsManager.GeneratePoints(this.transform);
        }
        private void Update()
        {
        ...
        {
            return _respawnPointsManager.GetRespawnPoint();
        }
        public void Respawn()
        {
            ...
            _characterPrefab.Parent = respawnPoint.transform;
        ...
        private void OnDrawGizmos()
        {
            ...
            _respawnPointsManager.OnDrawGizmosSelected();
        }
    }
}
