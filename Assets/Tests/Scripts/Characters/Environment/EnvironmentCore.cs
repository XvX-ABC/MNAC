...
namespace Tests.Characters.Environment
{
    ...
    public class EnvironmentCore : CharacterComponentBase_MonoComponent
    {
        Rigidbody _rbody;
        Core _core;
        ...
        {
            base.Awake();
            var definitions = GetComponent<IEnvironmentDefinitions>() ?? throw new ComponentCantFindException(this.gameObject, typeof(IEnvironmentDefinitions));
